...
class WppbTest extends TestCase {
  ...
  public function test_option_red() {
	...
	public function test_gradient() {
		...
		$this->assertEquals('<div class="wppb-wrapper "><div class="wppb-progress fixed"><span style="width: 50%; background: ff0000;background: -moz-linear-gradient(top, ff0000 0%, ffe6e6 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,ff0000), color-stop(100%,ffe6e6)); background: -webkit-linear-gradient(top, ff0000 0%,ffe6e6 100%); background: -o-linear-gradient(top, ff0000 0%,ffe6e6 100%); background: -ms-linear-gradient(top, .1 0%,ffe6e6 100%); background: linear-gradient(top, ff0000 0%,ffe6e6 100%); "background: -moz-linear-gradient(top, ff0000 0%, ffe6e6 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,ff0000), color-stop(100%,ffe6e6)); background: -webkit-linear-gradient(top, ff0000 0%,ffe6e6 100%); background: -o-linear-gradient(top, ff0000 0%,ffe6e6 100%); background: -ms-linear-gradient(top, .1 0%,ffe6e6 100%); background: linear-gradient(top, ff0000 0%,ffe6e6 100%); "><span></span></span></div></div>', $output);

		// negative gradient
		$output = do_shortcode('[wppb progress=50 color=ff0000 gradient=-.1]');
		$this->assertEquals('<div class="wppb-wrapper "><div class="wppb-progress fixed"><span style="width: 50%; background: ff0000;background: -moz-linear-gradient(top, ff0000 0%, 1a0000 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,ff0000), color-stop(100%,1a0000)); background: -webkit-linear-gradient(top, ff0000 0%,1a0000 100%); background: -o-linear-gradient(top, ff0000 0%,1a0000 100%); background: -ms-linear-gradient(top, -.1 0%,1a0000 100%); background: linear-gradient(top, ff0000 0%,1a0000 100%); "background: -moz-linear-gradient(top, ff0000 0%, 1a0000 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,ff0000), color-stop(100%,1a0000)); background: -webkit-linear-gradient(top, ff0000 0%,1a0000 100%); background: -o-linear-gradient(top, ff0000 0%,1a0000 100%); background: -ms-linear-gradient(top, -.1 0%,1a0000 100%); background: linear-gradient(top, ff0000 0%,1a0000 100%); "><span></span></span></div></div>', $output);

		// broken color + gradient
		$output = do_shortcode('[wppb progress=50 color=rgb(22,18,99 gradient=.1 ]');
		$this->assertEquals('<div class="wppb-wrapper "><div class="wppb-progress fixed"><span style="width: 50%; background: rgb(22,18,99;background: -moz-linear-gradient(top, rgb(22,18,99 0%, e8e8f0 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgb(22,18,99), color-stop(100%,e8e8f0)); background: -webkit-linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); background: -o-linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); background: -ms-linear-gradient(top, .1 0%,e8e8f0 100%); background: linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); "background: -moz-linear-gradient(top, rgb(22,18,99 0%, e8e8f0 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgb(22,18,99), color-stop(100%,e8e8f0)); background: -webkit-linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); background: -o-linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); background: -ms-linear-gradient(top, .1 0%,e8e8f0 100%); background: linear-gradient(top, rgb(22,18,99 0%,e8e8f0 100%); "><span></span></span></div></div>', $output);
	}
