...
class WppbTest extends TestCase {
  ...
  public function test_option_red() {
	...
	public function test_gradient() {
		...
		$this->assertEquals('<div class="wppb-wrapper "><div class="wppb-progress fixed"><span style="width: 50%; background: rgb(22,18,99;background: -moz-linear-gradient(top, rgb(22,18,99 0%, e6e7e9 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgb(22,18,99), color-stop(100%,e6e7e9)); background: -webkit-linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); background: -o-linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); background: -ms-linear-gradient(top, .1 0%,e6e7e9 100%); background: linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); "background: -moz-linear-gradient(top, rgb(22,18,99 0%, e6e7e9 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgb(22,18,99), color-stop(100%,e6e7e9)); background: -webkit-linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); background: -o-linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); background: -ms-linear-gradient(top, .1 0%,e6e7e9 100%); background: linear-gradient(top, rgb(22,18,99 0%,e6e7e9 100%); "><span></span></span></div></div>', $output);
	}
